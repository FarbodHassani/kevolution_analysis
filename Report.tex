...
\subsection{Comparing the $\Psi'$ in Gevolution with Riess Sciama effect at redshift 50.  {\color{red} Recheck!}}
{\Huge{Will be added from part of the report!} }
...
\paragraph{By corrector methods check the errors on variables}
...
We update the fields in the main file as following,
\begin{lstlisting}[language=C++,
  basicstyle=\tiny]
  //**********************
//Kessence - LeapFrog:START
